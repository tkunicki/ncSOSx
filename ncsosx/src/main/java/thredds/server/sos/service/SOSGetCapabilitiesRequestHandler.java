...
public class SOSGetCapabilitiesRequestHandler extends SOSBaseRequestHandler {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(SOSGetCapabilitiesRequestHandler.class);
    ...
    public void parseObservationList() throws IOException {
        ...
        for (Station station : featureCollection.getStations()) {
            ...
            DateRange stationDateRange = feature.getDateRange();
            ...
            if (stationDateRange != null) {
                ...
                newOffering.setObservationTimeBegin(stationDateRange.getStart().toDateTimeStringISO());
                newOffering.setObservationTimeEnd(stationDateRange.getEnd().toDateTimeStringISO());
...
//                newOffering.setObservationModel("")
                ...
                LOGGER.warn("Station {} skipped, doesn't appear to contain any observations", stationName);
            }
        }
    }
